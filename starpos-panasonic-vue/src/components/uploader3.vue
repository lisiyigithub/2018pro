    ...
    remove(index) {
      ...
      if (util.sesstionData("formObj") != false) {
        ...
        switch (_this.type[index]) {
          case 1:
            obj.door_img = "";obj.foy_img = "";obj.choc_img = "";
            break;
          case 2:
            obj.foy_img = "";obj.choc_img = "";
            break;
          case 3:
            obj.choc_img = "";
            break;
          case 4:
            obj.merc_bankcode_img = "";obj.hold_img = "";
            break;
          case 5:
            obj.hold_img = "";
            break;
          case 6:
            obj.met_img = "";obj.merc_openbank_img = "";
            break;
          case 7:
            obj.merc_openbank_img = "";
            break;
          case 8:
            obj.mer_con1_img = "";obj.mer_con2_img = "";
            break;
          case 9:
            obj.mer_con2_img = "";
            break;
