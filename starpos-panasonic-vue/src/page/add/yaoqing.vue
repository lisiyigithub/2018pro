  ...
  <div class="saoma">
    ...
    <div class="main">
      ...
      <!-- <ul class="shebei_block">
        ...
        <p style="color:#9C9C9C;padding-left:12px;">如有疑问，请联系业务人员</p>
    </div>
    <footer>
      <yd-button size="large" class="button" @click.native="goYanzheng" :disabled='!(list.length!=0)' style="color:#fff;box-shadow:none;">提交</yd-button>
    </footer>
  </div>
</template>
...
header{
  ...
  color:#fff;
  text-align:center;
  background-image: linear-gradient(-121deg, #4283eb 0%, #04b2ec 100%);
}
header span{
  float: left;
  padding-top: 25px;
